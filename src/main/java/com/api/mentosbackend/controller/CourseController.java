...
@CrossOrigin//para que cualquier aplicacion fronted pueda usar
@RestController//spring boot lo reconoce como un controllador
@RequestMapping("/api/v1/courses")//url que se va seguir para que se haga uso de ese controlador
@Api(tags = "Courses", value = "Web Service RESTful of courses")//descripcion, swagger
